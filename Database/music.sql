...
--
-- Database: `music-streaming-platform`
--
CREATE DATABASE IF NOT EXISTS `music-streaming-platform` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `music-streaming-platform`;
